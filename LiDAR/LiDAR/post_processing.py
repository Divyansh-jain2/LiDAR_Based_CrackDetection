...
df = pd.read_csv(r"/home/admin/dp/LiDAR/lidar_data_with_timestamp_high.csv")
...
angle_columns_120_to_240 = [col for col in df_pivot.columns if isinstance(col, (int, float)) and 120 <= col <= 240]

new_columns_order = (
    ['Time'] +
    [col for col in df_pivot.columns if col not in angle_columns_120_to_240 and col != 'Time'] +
    angle_columns_120_to_240
)
